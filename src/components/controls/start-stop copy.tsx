...
//@ts-ignore
import StreamingAvatar, { StreamingEvents, TaskType, VoiceEmotion } from "@heygen/streaming-avatar"
// import {
//   Configuration,
//   NewSessionData,
//   StreamingAvatarApi,
    ...
    if (lastMsg.role === "assistant" && lastMsg.content) {
      ...
      sentences.forEach(async (sentence) => {
        ...
        if (
          ...
          //   },
          // })
          await avatar.current?.speak({ text: trimmedSentence, task_type: TaskType.REPEAT }).catch((e) => {
            setDebug(e.message);
          });
        }
      })
